...
**Status:** steps 1–5 complete; step 6 half done: it has run against a real PS4 from a Mac browser and works, and the iPad is still to try. `npm test` (30) and `npm run test:bridge` (55) pass.

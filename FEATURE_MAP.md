...
| Driving widgets (speed, gear and suggested gear, rpm with rev markers, pedals) | Page | Implemented | `web/widgets.js` | Confirmed responding to real PS4 data (2026-09-22), including reverse ([D21](DECISIONS.md)). Boost unchecked. [Known issue 15](PROJECT_CONTEXT.md) |

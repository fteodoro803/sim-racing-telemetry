...
| Driving widgets (speed, gear and suggested gear, rpm with rev markers, pedals incl. clutch) | Page | Implemented | `web/widgets.js` | Confirmed responding to real PS4 data (2026-09-22), including reverse ([D21](DECISIONS.md)). RPM (bar/shift-lights) and Pedals (vertical/horizontal) restructure by container size ([D25](DECISIONS.md); [`DASHBOARD_PLAN.md`](DASHBOARD_PLAN.md) log 13). Boost unchecked. [Known issue 15](PROJECT_CONTEXT.md) |

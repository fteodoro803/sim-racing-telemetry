...
export const PRESET_LAYOUTS = {
  everything: [
    ...
    { widget: 'pedalTrace', col: 1, row: 5, w: 6, h: 2, variant: 'lines', window: 8 },
    ...
    { widget: 'tyres', col: 7, row: 5, w: 2, h: 4 },
    { widget: 'lapTable', col: 9, row: 5, w: 4, h: 4, variant: 'table' },
  ],
  timing: [
    { widget: 'currentLap', col: 1, row: 1, w: 6, h: 2 },
    { widget: 'delta', col: 7, row: 1, w: 6, h: 2, variant: 'gauge' },
    { widget: 'sectors', col: 1, row: 3, w: 12, h: 2, variant: 'segments' },
    { widget: 'speedChart', col: 1, row: 5, w: 6, h: 2 },
    { widget: 'deltaChart', col: 7, row: 5, w: 6, h: 2, variant: 'areaReadout' },
    { widget: 'lastLap', col: 1, row: 7, w: 2, h: 2, variant: 'dual' },
    { widget: 'bestLap', col: 3, row: 7, w: 2, h: 2, variant: 'sectorSplit' },
    { widget: 'predicted', col: 5, row: 7, w: 2, h: 2, variant: 'basisNote' },
  ...
  driving: [
    ...
    { widget: 'pedalTrace', col: 3, row: 6, w: 6, h: 3, variant: 'filled' },
    { widget: 'tyres', col: 9, row: 6, w: 4, h: 3 },
  ],
};

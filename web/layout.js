...
export const WIDGET_META = {
  ...
  rpm: {
    title: 'RPM', group: 'driving', minW: 3, minH: 1, addW: 6, addH: 1,
    variants: [
      { id: 'compact', title: 'Compact' },
      { id: 'bar', title: 'Bar' },
      { id: 'segmented', title: 'Segmented' },
      { id: 'barOnly', title: 'Bar Only' },
      { id: 'lights', title: 'Shift Lights' },
    ],
  },
  gear: { title: 'Gear', group: 'driving', minW: 2, minH: 2, addW: 2, addH: 3 },
...
export const PRESET_LAYOUTS = {
  everything: [
    ...
    { widget: 'rpm', col: 7, row: 1, w: 6, h: 1, variant: 'bar' },
  ...
  driving: [
    { widget: 'rpm', col: 1, row: 1, w: 12, h: 1, variant: 'bar' },
    { widget: 'gear', col: 1, row: 2, w: 4, h: 4 },
    { widget: 'speed', col: 5, row: 2, w: 6, h: 4 },
    { widget: 'currentLap', col: 11, row: 2, w: 2, h: 2 },
    { widget: 'delta', col: 11, row: 4, w: 2, h: 2 },
